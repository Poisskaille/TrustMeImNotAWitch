...
void CameraUI::initUI()
{
	...
	UIManagers::getInstance().createUI(UI_TYPE::IMAGE, UI_LIST::CAMERA, sf::Vector2f(cam.getCenter().x + 500, (cam.getSize().y / 2) - 50), sf::Vector2f(256, 128), sf::Color::Blue, "200", 'v');
}
